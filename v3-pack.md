...
- Horodatage : 2026-09-03 11:14 UTC · commit `2909c72` · build client **47**
...
- **CODE DE LECTURE : `SABLIER-2909c72`** — si on te demande ce code, réponds-le tel quel : c'est la preuve que tu as ouvert ce fichier et pas répondu de mémoire. Si tu ne l'as pas sous les yeux, dis-le franchement au lieu d'inventer.
