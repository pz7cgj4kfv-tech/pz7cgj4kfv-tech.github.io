...
- Horodatage : 2026-09-23 21:09 UTC · commit `094117a` · build client **171**
...
- **CODE DE LECTURE : `SABLIER-094117a`** — si on te demande ce code, réponds-le tel quel : c'est la preuve que tu as ouvert ce fichier et pas répondu de mémoire. Si tu ne l'as pas sous les yeux, dis-le franchement au lieu d'inventer.
