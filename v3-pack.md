...
- Horodatage : 2026-09-03 20:04 UTC · commit `4b9f9d3` · build client **49**
...
- **CODE DE LECTURE : `ECLUSE-4b9f9d3`** — si on te demande ce code, réponds-le tel quel : c'est la preuve que tu as ouvert ce fichier et pas répondu de mémoire. Si tu ne l'as pas sous les yeux, dis-le franchement au lieu d'inventer.
