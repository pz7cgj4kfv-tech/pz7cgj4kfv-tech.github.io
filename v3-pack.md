...
- Horodatage : 2026-09-23 09:36 UTC · commit `ca01a52` · build client **159**
...
- **CODE DE LECTURE : `SABLIER-ca01a52`** — si on te demande ce code, réponds-le tel quel : c'est la preuve que tu as ouvert ce fichier et pas répondu de mémoire. Si tu ne l'as pas sous les yeux, dis-le franchement au lieu d'inventer.
