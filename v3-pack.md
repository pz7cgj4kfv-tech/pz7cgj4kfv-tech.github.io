...
- Horodatage : 2026-09-05 14:30 UTC · commit `ba1f67e` · build client **49**
- Assertions de test : **520** dans 40 fichiers d'intégration (+ 27 tests unitaires de domaine)
...
- **CODE DE LECTURE : `ECLUSE-ba1f67e`** — si on te demande ce code, réponds-le tel quel : c'est la preuve que tu as ouvert ce fichier et pas répondu de mémoire. Si tu ne l'as pas sous les yeux, dis-le franchement au lieu d'inventer.
