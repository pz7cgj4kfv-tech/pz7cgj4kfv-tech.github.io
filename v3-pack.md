...
- Horodatage : 2026-09-08 13:32 UTC · commit `01bf8c9` · build client **80**
- Assertions de test : **856** dans 57 fichiers d'intégration (+ 37 tests unitaires de domaine)
...
- **CODE DE LECTURE : `ECLUSE-01bf8c9`** — si on te demande ce code, réponds-le tel quel : c'est la preuve que tu as ouvert ce fichier et pas répondu de mémoire. Si tu ne l'as pas sous les yeux, dis-le franchement au lieu d'inventer.
