(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,18566,(t,e,s)=>{e.exports=t.r(76562)},80904,t=>{"use strict";var e=t.i(43476),s=t.i(71645),i=t.i(18566);t.s(["default",0,function(){let t=(0,i.useRouter)(),[a,l]=(0,s.useState)(0);return(0,s.useEffect)(()=>{let e=[setTimeout(()=>l(1),400),setTimeout(()=>l(2),1400),setTimeout(()=>l(3),2400),setTimeout(()=>l(4),3100),setTimeout(()=>l(5),3900),setTimeout(()=>l(6),6e3),setTimeout(()=>t.push("/app"),7e3)];return()=>e.forEach(clearTimeout)},[t]),(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)("style",{children:`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── ONDES qui partent du centre \xe0 l'infini ── */
        .ripples {
          position: absolute;
          top: 50%; left: 50%;
        ...
        .ripple {
          position: absolute;
          border-radius: 50%;
          border: 1px solid rgba(255,191,158,0.4);
          top: 50%; left: 50%;
          width: 60px; height: 60px;
          transform: translate(-50%,-50%) scale(0);
          animation: rippleOut 4.5s cubic-bezier(0.1,0.4,0.3,1) infinite;
        }
        .ripple:nth-child(1) { animation-delay: 0s; }
        .ripple:nth-child(2) { animation-delay: 0.9s; border-color: rgba(226,124,0,0.3); }
        .ripple:nth-child(3) { animation-delay: 1.8s; border-color: rgba(255,191,158,0.2); }
        .ripple:nth-child(4) { animation-delay: 2.7s; border-color: rgba(226,124,0,0.15); }
        .ripple:nth-child(5) { animation-delay: 3.6s; border-color: rgba(255,191,158,0.1); }
        ...
        .sand-top {
          ...
          transition: opacity 1.4s ease, transform 1.4s cubic-bezier(0.34,1.1,0.64,1);
        }
        .sand-bottom {
          opacity: ${+(a>=2)};
          transform: translateY(${a>=2?0:10}px);
          transition: opacity 1.4s ease 0.25s, transform 1.4s cubic-bezier(0.34,1.1,0.64,1) 0.25s;
        }
        .text-clu {
          opacity: ${+(a>=3)};
          transform: translateX(${a>=3?0:-18}px);
          transition: opacity 1.4s ease, transform 1.4s cubic-bezier(0.22,1,0.36,1);
        }
        .text-tch {
          opacity: ${+(a>=4)};
          transform: translateX(${a>=4?0:18}px);
          transition: opacity 1.4s ease, transform 1.4s cubic-bezier(0.22,1,0.36,1);
        }
