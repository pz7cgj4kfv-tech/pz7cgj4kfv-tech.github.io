(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,17927,e=>{"use strict";let t=(0,e.i(88715).createClient)("https://fnucdicfcjoxbozpfdau.supabase.co","sb_publishable_TXWkldkILlJ5G9OTOfiCLg_NYZLVMTZ");e.s(["supabase",0,t])},31713,e=>{"use strict";var t=e.i(43476),i=e.i(71645),n=e.i(17927);e.s(["default",0,function(){let[e,r]=(0,i.useState)(""),[a,s]=(0,i.useState)(!1),[l,o]=(0,i.useState)(!1),[d,c]=(0,i.useState)(""),[p,g]=(0,i.useState)(null),[m,x]=(0,i.useState)(!1),u=(0,i.useRef)(null);(0,i.useEffect)(()=>{window.Capacitor?.isNativePlatform?.()&&(x(!0),window.location.replace("app2.html"))},[]),(0,i.useEffect)(()=>{n.supabase.from("waitlist").select("id",{count:"exact",head:!0}).then(({count:e})=>{null!=e&&g(e)},()=>{})},[]);let f=async()=>{if(!e.trim()||!e.includes("@"))return void c("Email invalide");o(!0),c("");let{error:t}=await n.supabase.from("waitlist").insert({email:e.trim().toLowerCase()});(o(!1),t&&"23505"===t.code)?s(!0):t?c("Erreur — réessaie"):(s(!0),g(e=>null!=e?e+1:null))};return m?null:(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("style",{children:`
