(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,18566,(t,e,s)=>{e.exports=t.r(76562)},80904,t=>{"use strict";var e=t.i(43476),s=t.i(71645),i=t.i(18566);t.s(["default",0,function(){let t=(0,i.useRouter)(),[a,l]=(0,s.useState)(0);return(0,s.useEffect)(()=>{let e=[setTimeout(()=>l(1),150),setTimeout(()=>l(2),500),setTimeout(()=>l(3),800),setTimeout(()=>l(4),1e3),setTimeout(()=>l(5),1300),setTimeout(()=>l(6),2400),setTimeout(()=>t.push("/app"),3e3)];return()=>e.forEach(clearTimeout)},[t]),(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)("style",{children:`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ripple {
          position: absolute;
          border-radius: 50%;
          border: 1.5px solid rgba(255,191,158,0.35);
          top: 50%; left: 50%;
        ...
        .ripple:nth-child(2) { width: 80px; height: 80px; animation-delay: 0.6s; border-color: rgba(226,124,0,0.25); }
        .ripple:nth-child(3) { width: 80px; height: 80px; animation-delay: 1.2s; }
        .ripple:nth-child(4) { width: 80px; height: 80px; animation-delay: 1.8s; border-color: rgba(226,124,0,0.15); }
        .ripple:nth-child(5) { width: 80px; height: 80px; animation-delay: 2.4s; }
